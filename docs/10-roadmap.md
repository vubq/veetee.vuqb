...
| M3 | UDP v3 framing/AES-CTR/bounded-reorder core đã có host-only golden/test; chưa đưa carrier vào runtime critical path | MQTT client/gateway/socket, stream barrier/loss soak, BOM/descriptor/safety policy, hardware MCP, assets/OTA và transport-promotion evidence |
