...
Lệnh tái tạo (cần `npx lv_font_conv` phiên bản đã pin trong toolchain):

```text
npx --yes lv_font_conv --size 16 --bpp 4 --format lvgl \
...
npx --yes lv_font_conv --size 26 --bpp 4 --format lvgl \
  --font /usr/share/fonts/truetype/noto/NotoSans-Regular.ttf \
  -r 0x20-0x7E -r 0xA0-0xFF -r 0x100-0x17F -r 0x1EA0-0x1EF9 \
